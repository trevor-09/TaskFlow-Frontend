...
function App() {
  ...
  const MainApp = () => (
    <div className="min-h-screen bg-[#f6f8fc] text-gray-800 font-sans">
      <nav className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center shadow-sm">
        <h1 className="text-xl font-bold tracking-tight text-blue-600">MERN To-Do App</h1>
        <button
          onClick={logout}
      ...
      <main className="max-w-3xl mx-auto py-10 px-4">
        ...
        >
          ...
          <button
            type="submit"
            className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-medium shadow-sm"
          >
            {loading ? "Adding..." : "Add"}
          </button>
        </form>
        ...
        <ul className="space-y-4">
          {filteredTasks.map((task) => (
            <li
              key={task._id}
              className="bg-white border border-gray-200 rounded-md p-4 shadow flex flex-col md:flex-row md:items-center md:justify-between"
            >
              <div>
              ...
              <div className="flex items-center gap-3 mt-3 md:mt-0">
                <button
                  ...
                  className={`px-3 py-1 text-sm font-medium rounded-md shadow ${
                    task.status === "pending"
      ...
      <footer className="bg-white border-t border-gray-200 text-center text-sm text-gray-600 py-4 shadow-inner">
